...
export const AppFormControlWrapper = styled.div`
  ...
  &:hover .input-label.shrink {
    color: ${({ theme }: { theme: any }) => theme.palette.primary};

    .ant-form-item-has-error & {
      color: ${({ theme }: { theme: any }) => theme.palette.error};
    }
  }
  ...
  & &.app-number-range-picker {
    & .ant-input-number:hover:first-child {
      ...
      border-color: ${({ theme }: { theme: any }) =>
        theme.border.baseColor} !important;
...
export const InputContainer = styled.div`
  ...
  &:hover {
    & .form-control-fieldset {
      border-color: ${({ theme }: { theme: any }) => theme.palette.primary};
    }
  ...
  .ant-form-item-has-error &:hover {
    & .form-control-fieldset {
      border-color: ${({ theme }: { theme: any }) => theme.palette.error};
    }
...
export const FormControlFieldset = styled.fieldset`
  ...
  bottom: 0;
  margin: 0;
  border-color: ${({ theme }: { theme: any }) => theme.border.baseColor};
  padding: 0 8px;
  overflow: hidden;
  position: absolute;
  border-style: solid;

...
import { PopoverProps, TablePaginationConfig } from 'antd';
...
export interface RenderEditSelectCellProps<TRow, TSummaryRow = unknown>
...
export interface UndoRedoProcessProps {
  rows: any[];
  columns: any[];
...
declare const MiInputField: <TRow, TSummaryRow>({
  row,
  column,
  onRowChange,
  onClose,
...
export declare const TimeInput: typeof MiInputField;
export declare const DateInput: typeof MiInputField;
export declare const NumberEditor: typeof MiInputField;
export declare const TextEditor: typeof MiInputField;
export declare const DateTimeInput: typeof MiInputField;
export declare const MiTable: (props: MiTableProps) => JSX.Element;
